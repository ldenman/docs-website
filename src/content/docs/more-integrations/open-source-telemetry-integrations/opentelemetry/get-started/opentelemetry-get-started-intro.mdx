...
## Monitor Jenkins [#otel-jenkins]

Monitor Jenkins with OpenTelemtry. See the instructions in [Monitor Jenkins with OpenTelemetry and New Relic](/docs/more-integrations/open-source-telemetry-integrations/jenkins/monitoring-jenkins-ot).
